# Origin codel from LABOR sampler
# /*!
...
from ladies import LadiesSampler, normalized_edata
...
class DataModule(LightningDataModule):
    def __init__(self, dataset_name, data_cpu=False, graph_cpu=False, use_uva=False, fan_out=[10, 25],
                 device=th.device('cpu'), batch_size=1000, num_workers=4, sampler='bandit-ladies', importance_sampling=0, layer_dependency=False, batch_dependency=1, cache_size=0):
        super().__init__()
        ...
        if sampler == 'neighbor':
            ...
            sampler = BanditSampler(fanouts, importance_sampling=importance_sampling) #, prefetch_node_feats='features', prefetch_edge_feats='edge_weights', prefetch_labels='labels')
