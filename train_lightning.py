...
class DataModule(LightningDataModule):
    def __init__(
        ...
        # print(g.out_edges([2], form='eid'))
        # print(g.out_edges([3], form='eid'))
        # print(g.in_edges([1], form='eid'))
        if undirected:
            src, dst = g.all_edges()
            g.add_edges(dst, src)
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--early-stopping-patience", type=int, default=100)
